...
/**
 * Event triggered when a SCORM load process completes.
 *
...
class scorm_load_completed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventscormloadcompleted', 'block_blc_modules');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed a SCORM load process " .
            "in course with id '$this->courseid': {$this->other['successful']} successful, " .
            "{$this->other['failed']} failed out of {$this->other['totalmodules']} total.";
    }
