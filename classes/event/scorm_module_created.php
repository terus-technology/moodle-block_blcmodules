...
/**
 * Event triggered when a SCORM module is created via BLC Modules plugin.
 *
 ...
 *     - int version: The SCORM package version.
 *     - string subject: The subject of the SCORM module.
 *     - int sectionid: The course section ID.
 * }
 */
class scorm_module_created extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('eventscormmodulecreated', 'block_blc_modules');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created SCORM module '{$this->other['scormname']}' " .
            "(scormid: {$this->other['scormid']}, version: {$this->other['version']}) " .
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['scormurl'])) {
            throw new \coding_exception('The \'scormurl\' value must be set in other.');
        }
