...
use block_blc_modules\helper\blccurlcache_helper;
 ...
 * // enable cache
 * $c = new blccurl_helper(array('cache'=>true));
 * // enable cookie
 * $c = new blccurl_helper(array('cookie'=>true));
 * // enable proxy
 * $c = new blccurl_helper(array('proxy'=>true));
 *
 * // HTTP GET Method
...
class blccurl_helper {
     ...
     */
    private function format_header($ch, $header) {
        if (strlen($header) > 2) {
