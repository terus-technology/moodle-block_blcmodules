...
$fileinfo = 'time: '.time().'\r\n';
$fileinfo .= 'Postinfo = '.print_r($_POST).'\r\n\r\n';
...
$fileinfo .= '$scormurls = '.print_r($scormurls).'\r\n\r\n';
...
$requesturi = $CFG->wwwroot;
	...
	if  (in_array  ('curl', get_loaded_extensions())) {
        ...
        $fileinfo .= 'curlavailable? = CURL is available on your web server \r\n\r\n'; 
 
    }  else {
        $fileinfo .= 'curlavailable? = CURL is NOT available on your web server \r\n\r\n';
    }
